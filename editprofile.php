      ...
      <div class="row">
        ...
        <div class="col-md-4">
          ...
          <div class="form-group">
            ...
            <textarea class="form-control" name="bio" id="bio" rows="5" placeholder="Conte quem você é, oque faz, etc..."><?= $userData->bio ?></textarea>
          </div>
        </div>
      </div>
    </form>
      ...
      <div class="col-md-4">
        ...
        <form action="<?= $BASE_URL ?>/user_process.php" method="post" >
          ...
          <div class="form-group">
            ...
            <input type="password" class="form-control-file" name="password" placeholder="Digite sua nova senha">
          </div>
          <div class="form-group">
